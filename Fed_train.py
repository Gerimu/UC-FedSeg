...
parser.add_argument('--root_path_am', type=str,
                    default='../data/AMOS', help='root dir for data')
parser.add_argument('--root_path_fl', type=str,
                    default='../data/FLARE22', help='root dir for data')
...
parser.add_argument('--output_dir', type=str,
                    default='./output/FedUC_client_18',
                    help='output dir')
...
if args.dataset_0 == "Synapse":
    args.root_path_sy = os.path.join(args.root_path_sy, "train")
...
if __name__ == "__main__":
    ...
    for round in iterator:
        ...
        thr = torch.tensor([thr0, thr1, thr2]) # ,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5
        ...
        if round % 10 == 0:
            logging.info("Avg Time used: {}".format(np.mean(avgtime)))
